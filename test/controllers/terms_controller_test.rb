...
class TermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create term' do
    assert_difference('Term.count') do
      post terms_url, params: { term: { name: @term.name, slug: @term.slug, term_group: @term.term_group } }
    end
  ...
  test 'should update term' do
    patch term_url(@term), params: { term: { name: @term.name, slug: @term.slug, term_group: @term.term_group } }
