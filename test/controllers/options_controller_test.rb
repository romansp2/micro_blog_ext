...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create option' do
    assert_difference('Option.count') do
      post options_url, params: { option: { autoload: @option.autoload, option_name: @option.option_name, option_value: @option.option_value } }
    end
  ...
  test 'should update option' do
    patch option_url(@option), params: { option: { autoload: @option.autoload, option_name: @option.option_name, option_value: @option.option_value } }
