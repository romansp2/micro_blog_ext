...
class UserOptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create user_option' do
    assert_difference('UserOption.count') do
      post user_options_url, params: { user_option: { option_key: @user_option.option_key, option_value: @user_option.option_value, user_id: @user_option.user_id } }
    end
  ...
  test 'should update user_option' do
    patch user_option_url(@user_option), params: { user_option: { option_key: @user_option.option_key, option_value: @user_option.option_value, user_id: @user_option.user_id } }
